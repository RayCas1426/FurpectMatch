...
import HomepageColumnAdoptType from "./HomepageColumnAdoptType"; 
import HomepageStackPetAdoption from "./HomepageStackPetAdoption"; 
    ...
    return (
        <div>
                    ...
                    <div className="relative flex w-[82%] flex-col items-center gap-14 lg:w-full md:w-full sm:gap-7">
                        <div className="st-[122px] flex flex-col items-start gap-[42px] self-stretch">
                            <div className="flex flex-col items-start gap-4 self-stretch">
                                ...
                                >
                                    Give a new life to your furry friends
                                </Heading>
                            </div>
                            <Text
                                size="textlg"
                            ...
                            >
                                Pet adoption is a vital aspect of animal welfare, offering hope and a fresh start to pets in need.
                            </Text>
                            <a href="/Shop">
                              <Button
                    ...
                    <div className="relative flex flex-col items-center">
                        ...
                        <div className="absolute bottom-[30px] flex space-x-5">
                            <Img
                                src="images/dog1.png"
                                alt="Dog 1"
                                className="h-auto w-[50%] max-w-[200px] object-cover" 
                            />
                            <Img
                                src="images/dog2.png"
                                alt="Dog 2"
            ...
            <div className="relative z-[4] w-full bg-white-a700 py-[68px] lg:py-8 md:mx-0 md:py-5 sm:py-4">
                <HomepageStackPetAdoption />
            </div>
            <HomepageColumnAdoptType />
            <HomepageColumnTwo />
